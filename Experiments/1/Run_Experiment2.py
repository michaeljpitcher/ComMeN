...
time_limit = 5.0
network_config_filename = 'PulmonaryNetwork_EXP1a.cfg'
event_config_filename = 'PTBModel_Events_EXP1a.cfg'
seeding_config_filename = 'PTBModel_Seeding_EXP1a.cfg'
