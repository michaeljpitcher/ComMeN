...
class BacteriaChangeStateV2TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.event_f = BacteriaChangeByOxygenVersion2(0.1, self.nodes, BACTERIUM_FAST, BACTERIUM_SLOW, -1 * self.sigmoid,
                                                      self.half_sat)
        self.event_s = BacteriaChangeByOxygenVersion2(0.2, self.nodes, BACTERIUM_SLOW, BACTERIUM_FAST, self.sigmoid,
                                                      self.half_sat)
...
class GetBacteriaChangeEventsTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sigmoid = 1.1
        self.half_sat = 1.2
        self.events = get_bacteria_change_v2_events(self.nodes, {BACTERIUM_FAST: 0.1, BACTERIUM_SLOW: 0.2},
                                                    self.sigmoid, self.half_sat)
