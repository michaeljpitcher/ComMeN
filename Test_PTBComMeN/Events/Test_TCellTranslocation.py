...
class TCellTranslocationBloodTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.event = TCellTranslocationBlood(0.1, self.nodes, T_CELL_ACTIVATED)
...
class GetTCellTranslocationEventsTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.rates = {T_CELL_ACTIVATED: 0.1}
        self.events = get_t_cell_translocation_events(self.nodes, self.rates)
