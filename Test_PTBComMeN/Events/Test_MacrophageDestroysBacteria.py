...
class GetMacrophageDestroyBacteriaEventsTestCase(unittest.TestCase):
    ...
    def setUp(self):
        compartments = [MACROPHAGE_REGULAR, MACROPHAGE_ACTIVATED, BACTERIUM_FAST, BACTERIUM_SLOW,
                        BACTERIUM_INTRACELLULAR]
        self.nodes = [LungPatch(0, compartments, 0.9, 0.3)]
        self.regular_rates = {BACTERIUM_FAST: 0.1, BACTERIUM_SLOW: 0.2}
        self.activated_rates = {BACTERIUM_FAST: 0.3, BACTERIUM_SLOW: 0.4}
