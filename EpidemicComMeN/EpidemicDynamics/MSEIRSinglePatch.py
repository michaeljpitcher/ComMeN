...
from ComMeN import *
from EpidemicComMeN.EpidemicCompartments import MATERNALLY_IMMUNE, SUSCEPTIBLE, EXPOSED, INFECTIOUS, RECOVERED, MSEIR_compartments
...
class MSEIRSinglePatchDynamics(Dynamics):
    ...
    def _end_simulation(self):
        ...
        """
        return self.network.nodes[0][EXPOSED] == 0 and self.network.nodes[0][INFECTIOUS] == 0
